...
const WorkoutSVG: React.FC = () => {
  const originalWidth = 1020;
  const originalHeight = 666.18;
  ...
  return (
    ...
    >
      ...
      <Ellipse
        ...
        ry={12.89}
      />
      <G fill="#d6f0ff" opacity={0.5}>
        <Path d="M708.28 68.4a10.16 10.16 0 0110.16 10.16v282.5h-20.32V78.55a10.16 10.16 0 0110.16-10.15zm222.93 0a10.16 10.16 0 0110.16 10.16v282.5H921V78.55a10.16 10.16 0 0110.21-10.15z" />
        <Rect
          width={20.32}
          height={361.84}
          x={899.59}
